...
export function Modifier(props){
  ...
  useEffect(()=>{
    ...
    // var content = modifierList.filter(obj =>{
  ...
  const findMyStuff = (name) => {
    ...
    var modifierList = props.dropDownItems
    var content = modifierList.find(obj =>{
      console.log('obj.name is ', obj.name, 'input name is ', name)
      return obj.name === name
    })
    var control = ''
    // if (control) {control = content.controls[0].type}
    console.log(content)
