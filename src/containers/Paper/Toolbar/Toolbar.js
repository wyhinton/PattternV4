...
const Toolbar = (props) => {
  const { activeTool, fullscreen, imageSize, showLayers, showGrid, sayHello, panels } = props
  console.log(`%c${activeTool}`, 'color: lightgrey')
  console.log('toolbar props: ', props);
  return (
    <div className=
      {
        `Toolbar-${(panels.sources.filter(function(e) {
          if (e.controls) {
            return e.controls.inEditMode == true
          } else {
            return [0,1]
          }
        }
    ...
    >
      ...
      <span></span>
      <div>
        <a title={'Fork me on GitHub'} href={'https://github.com/react-paper/react-paper-bindings'}>
