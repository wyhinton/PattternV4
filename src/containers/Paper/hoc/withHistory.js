...
export default function withHistory(WrappedComponent) {
  ...
  return class extends Component {
    ...
    componentDidUpdate(nextProps) {
      console.log('with history props', this.props);
      // if (this.props.testHistory !== nextProps.props.testHistory){
      //   console.log('different test history passed');
      // }
    }

    componentDidMount() {
      document.addEventListener('keydown', this.keyDown)
      console.log('with history props are', {...this.props});
    }
